...
- `adressevaelger.go` — Adressevælgeren: free-text address search (phonetic → ASCII re-spelling → `/vask/` for historical designations; *nedlagt* addresses are rejected), plus batch enrichment of DAR results with street/postal/municipality
